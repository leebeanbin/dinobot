...
from core.database import thread_cache_manager, metrics_collector
from core.exceptions import (
    DiscordAPIException,
    safe_execution,
    global_exception_handler,
)
from core.decorators import track_discord_command
from core.metrics import get_metrics_collector
from .analytics import analytics_service
from .search_service import search_service
from models.interfaces import IDiscordService
...
class DiscordService(IDiscordService):
    ...
    def __init__(self):
        ...
        logger.info("🤖 Discord service initialization complete")
    ...
    async def start_bot(self) -> bool:
        ...
        try:
            ...
            logger.info("🔑 Discord bot login starting...")
