...
class SimpleStatsService:
    ...
    async def generate_stats_chart(
        ...
        try:
            if stats_type == "daily":
                return await chart_generator.generate_daily_stats_chart(stats)
            elif stats_type == "weekly":
                return await chart_generator.generate_weekly_stats_chart(stats)
            elif stats_type == "monthly":
                return await chart_generator.generate_monthly_stats_chart(stats)
            elif stats_type == "user":
                return await chart_generator.generate_user_productivity_chart(stats)
            elif stats_type == "team":
                return await chart_generator.generate_team_comparison_chart(stats)
            elif stats_type == "task_completion":
                return await chart_generator.generate_task_completion_chart(stats)
            elif stats_type == "trends":
                return await chart_generator.generate_trends_chart(stats)
            else:
